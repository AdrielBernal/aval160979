...
public class CadastroAluno extends JPanel {
	...
	public CadastroAluno() {
		...
		txfRa = new JTextField();
		GridBagConstraints gbc_txfRa = new GridBagConstraints();
		gbc_txfRa.anchor = GridBagConstraints.WEST;
		gbc_txfRa.insets = new Insets(0, 0, 0, 5);
		gbc_txfRa.gridx = 1;
		gbc_txfRa.gridy = 3;
		panel.add(txfRa, gbc_txfRa);
		txfRa.setColumns(7);
